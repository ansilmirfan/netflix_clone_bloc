...
class MoviesDetaisModel {
    ...
    factory MoviesDetaisModel.fromRawJson(String str) => MoviesDetaisModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory MoviesDetaisModel.fromJson(Map<String, dynamic> json) => MoviesDetaisModel(
        adult: json["adult"],
